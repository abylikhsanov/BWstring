...
namespace bwstring {
    ...
    class BWString {
        char *_str = nullptr;
        size_t _str_len = 0;
        using bwsp = std::shared_ptr<BWString>;
        using split_ptr = std::unique_ptr<bwsp[]>;
        mutable split_ptr _split_array;
    ...
    public:
        ...
        explicit BWString(const char *s);
